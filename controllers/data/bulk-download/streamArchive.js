...
const streamArchive = (pathToTmpDir, res) => (new Promise ((resolve, reject) => {
  /* Create Zip Archive */
  ...
  res.on('close', () => {
    ...
    moduleLogger.info('archiver has been finalized and the output file descriptor has closed.', null);
