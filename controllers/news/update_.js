...
const getTagInsertQuery = (tags = [], existingTags = [], newsId) =>
  tags
...
const getTagDeleteQuery = (tags = [], existingTags = [], newsId) =>
  existingTags
...
const keyIsSet = safePathOr(false)(
...
const updateController = async (req, res) => {
  ...
  const missingKeys = requiredKeys.filter(
    (key) => !keyIsSet(['story', key])(req.body),
  );
