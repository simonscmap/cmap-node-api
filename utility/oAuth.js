...
const readCredentials = readJSON('./credentials.json').pipe(
  S.map(generateClientFromCredentials),
);
...
const init = ap(readToken)(ap(readCredentials)(resolve(getGmailClient)));
