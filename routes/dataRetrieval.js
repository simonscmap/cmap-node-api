...
router.get(
  '/query',
  asyncControllerWrapper(dataRetrievalController.customQuery),
);

// Stored procedure route
router.get(
  '/sp',
  asyncControllerWrapper(dataRetrievalController.storedProcedure),
);

// Table stats endpoint
router.get(
  '/tablestats',
  asyncControllerWrapper(dataRetrievalController.tableStats),
);
