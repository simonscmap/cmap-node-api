...
async function testBulkDownload() {
  ...
  console.log('📅 Time:', filters.temporal.startDate, 'to', filters.temporal.endDate);
  ...
  try {
    const result = await tester.post('/api/data/bulk-download', requestBody, { formData: true });
